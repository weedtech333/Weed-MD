...
global.channelLink = "https://whatsapp.com/channel/0029VbAxlQKHFxOvBw4stl3s";
      ...
      //  if (!message.key.fromMe) incrementMessageCount(chatId, senderId);
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.dev') || 
                 userMessage.startsWith('.developer') || 
                 userMessage.startsWith('.devs'):
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363418937884318@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363418937884318@newsletter';
